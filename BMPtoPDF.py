...
class BMPtoPDFConverter:
    def __init__(self, root):
        self.root = root
        self.root.title("BMP to PDF Converter")
        self.file_list = []

        self.label = Label(root, text="Selected BMP Files:")
        self.label.pack()
        ...
        self.add_button = Button(root, text="Add BMP Files", command=self.add_files)
...
if __name__ == "__main__":
    root = Tk()
    converter = BMPtoPDFConverter(root)
    root.mainloop()